...
<div id="login-page" class="login-container">
  <div class="login-box">
    ...
    <span class="link" onclick="showReset()">Mot de passe oublié ?</span>
...
<div id="reset-page" class="login-container" style="display:none;">
  <div class="reset-box">
    ...
    <button onclick="resetPassword()">Récupérer le mot de passe</button>
    <span class="link" onclick="showLogin()">Retour à la connexion</span>
...
<div id="dashboard" style="display:none;">
  <header>
    ...
    <button onclick="logout()" style="background:#c0000c; color:white; border:none; border-radius:6px; padding:6px 12px; cursor:pointer;">Déconnexion</button>
  </header>
  <nav>
  ...
  <main>
    ...
    <section id="messagerie">
      <div class="card">
        ...
        <button class="btn" onclick="openMessageForm()">Écrire un message</button>
...
// Messages stockés côté navigateur
